...
<div class="fh5co-narrow-content animated fadeInLeft" data-animate-effect="fadeInLeft">
		<div class="fh5co-text">
				...
				<h3>簡歷</h3>
				<div class="item animated fadeInLeft about-title-div"><p class="about-title">Links</p></div>
				<a href="https://github.com/SmoothieNoIce">Github</a>
				<a href="https://bitbucket.org/dashboard/repositories">Bitbucket</a>
				<div class="item animated fadeInLeft about-title-div"><p class="about-title">Portfolio</p></div>
				...
				<div class="item animated fadeInLeft about-title-div"><p class="about-title">Technique</p></div>
				<p>＊Web Design</p>
				<p>＊Android APP Design</p>
				<div class="item animated fadeInLeft about-title-div"><p class="about-title">Programming Language</p></div>
				<p>＊Java</p>
				<p>＊Javascript</p>
				<p>＊Php</p>
				<p>＊Python</p>
				<p>＊Golang/p>
				<p>＊Html/css</p>
				<div class="item animated fadeInLeft about-title-div"><p class="about-title">FrameWork</p></div>
				<p>＊Laravel</p>
				<p>＊Vue.js</p>
				<div class="item animated fadeInLeft about-title-div"><p class="about-title">Tools</p></div>
				<p>＊Bootstrap</p>
				<p>＊Firebase</p>
				<p>＊Docker</p>
				<div class="item animated fadeInLeft about-title-div"><p class="about-title">Database</p></div>
				<p>＊MySQL</p>
				<p>＊PGSQL</p>
				<p>＊Sqlite</p>
				<p>＊Radis</p>
