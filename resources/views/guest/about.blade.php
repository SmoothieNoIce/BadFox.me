...
<div class="fh5co-narrow-content animated fadeInLeft" data-animate-effect="fadeInLeft">
		<div class="fh5co-text">
				...
				<div class="item animated fadeInLeft about-title-div">
					<p class="about-title">Links</p></div>
				...
				<div class="item animated fadeInLeft about-title-div">
					<p class="about-title">Technique</p>
					<p>＊Web Design</p>
					<p>＊Android APP Design</p>
				</div>

				<div class="item animated fadeInLeft about-title-div">
					<p class="about-title">Programming Language</p>
					<p>＊Java</p>
					<p>＊Javascript</p>
					<p>＊Php</p>
					<p>＊Python</p>
				...
				<div class="item animated fadeInLeft about-title-div">
					<p class="about-title">FrameWork</p>
					<p>＊Laravel</p>
					<p>＊Vue.js</p>
				</div>

				<div class="item animated fadeInLeft about-title-div">
					<p class="about-title">Tools</p>
					<p>＊Bootstrap</p>
					<p>＊Firebase</p>
					<p>＊Docker</p>
				</div>
				...
				<div class="item animated fadeInLeft about-title-div">
					<p class="about-title">Database</p>
					<p>＊MySQL</p>
					<p>＊PGSQL</p>
					<p>＊Sqlite</p>
					<p>＊Radis</p>
